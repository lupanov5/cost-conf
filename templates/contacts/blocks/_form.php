<form action="" class="nx-section">
    ...
    <div class="nx-actions nx-actions_note">
        ...
        <div class="nx-actions__item">
            <div class="note">Нажимая на кнопку “Задать вопрос ” вы даете согласие на обработку <a href="/politics/" class="link"><span>персональных данных</span></a>
            </div>
        </div>
    </div>
</form>