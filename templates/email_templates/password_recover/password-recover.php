                ...
                <tr>
                    <td align="left" style="text-align: left;">
                        ...
                        <table cellpadding="0" cellspacing="0" style="width: 100%; margin: 0 auto;" class="table-lg">
                            ...
                            <tr>
                                <td style="padding:30px 0 20px;margin:0;">
                                    <div class="h1 pb-10"><b>Восстановление пароля</b></div>
                                    <div>Вы запросили восстановление пароля на сайте <a href="#SERVER_NAME#" class="link"><span>#SITE_NAME#</span></a>.
                                        <br> Нажмите на кнопку ниже, чтобы перейти к восстановлению
                                    </div>
                                </td>
                            </tr>
                        </table>
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" class="btn">
                                        ...
                                        <tr>
                                            <td align="center" valign="middle" style="padding:12px 20px">
                                                <a  href="#LINK#" style="font-weight: 500;text-decoration:none;color:#ffffff;" target="_blank">Восстановить пароль</a>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
                        ...
                        <table cellpadding="0" cellspacing="0" style="width: 100%; margin: 0 auto;">
                            <!-- Заголовок -->
                            <tr>
                                <td style="padding:15px 0 40px;margin:0; border-top: 2px solid #F5F5F5;">
                                    <div class="error text text-lg pb-5">
                                        <b>Обратите внимание!</b>
                                    </div>
                                    <div class="text text_med">
                                        Если вы не запрашивали смену пароля, срочно <a href="/users/info/" class="link">смените пароль </a> или <a href="mailto:#EMAIL#"
                                           class="link">обратитесь в поддержку </a></div>
                                </td>
                            </tr>
                        </table>
